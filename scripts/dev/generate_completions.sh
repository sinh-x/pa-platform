...
perl \
  -e '
    ...
    s/(complete -c opa -n __opa_deploy_completing -l objective -d '\''Deployment objective'\'' -r\n)/$1complete -c opa -n __opa_deploy_completing -l objective-file -d '\''Objective from file'\'' -r -a '\''(complete -C "echo " | string match -r "^[^ ]+")'\''\ncomplete -c opa -n __opa_deploy_completing -l list-modes -d '\''List available deploy modes'\''\ncomplete -c opa -n __opa_deploy_completing -l validate -d '\''Validate without deploying'\''\ncomplete -c opa -f -n __opa_deploy_completing -l provider -d '\''Provider'\'' -r -a '\''openai minimax deepseek'\''\ncomplete -c opa -f -n __opa_deploy_completing -l model -d '\''Model'\'' -r -a '\''gpt-5.5 MiniMax-M2.7 deepseek-v4-pro openai\/gpt-5.5 minimax-coding-plan\/MiniMax-M2.7 deepseek\/deepseek-v4-pro'\''\ncomplete -c opa -f -n __opa_deploy_completing -l team-model -d '\''Team model'\'' -r -a '\''gpt-5.5 MiniMax-M2.7 deepseek-v4-pro openai\/gpt-5.5 minimax-coding-plan\/MiniMax-M2.7 deepseek\/deepseek-v4-pro'\''\ncomplete -c opa -f -n __opa_deploy_completing -l agent-model -d '\''Agent model'\'' -r -a '\''gpt-5.5 MiniMax-M2.7 deepseek-v4-pro openai\/gpt-5.5 minimax-coding-plan\/MiniMax-M2.7 deepseek\/deepseek-v4-pro'\''\n/;
