...
node -e "
const fs = require('fs');
for (const file of ['package.json', 'packages/pa-core/package.json', 'packages/opencode-pa/package.json', 'packages/pi-pa/package.json']) {
...
git add package.json packages/pa-core/package.json packages/opencode-pa/package.json packages/pi-pa/package.json flake.nix
