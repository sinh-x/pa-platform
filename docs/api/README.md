...
| 4 | CLI Reference | [cli-reference.md](./cli-reference.md) | All 18 top-level commands and ~60 subcommands with flags, defaults, and usage examples. Covers `pa-core` and the `opa` adapter CLI. |
