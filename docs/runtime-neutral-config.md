...
`pa-core` owns shared configuration parsing and state. Runtime adapters provide runtime-specific spawning, hooks, model/provider resolution, and tool descriptions.
...
- `opa` interprets shared team config for opencode execution.
