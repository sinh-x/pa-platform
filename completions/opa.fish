...
function __opa_ticket_ids
    opa ticket list 2>/dev/null | awk 'NR>1 && /^[A-Z]/ {print $1}'
end
...
complete -c opa -n '__fish_seen_subcommand_from schedule; and test (count (commandline -opc)) -eq 3' -a 'hourly daily weekly monthly' -d 'Repeat interval'
complete -c opa -n '__fish_seen_subcommand_from schedule' -l repeat -d 'Repeat interval' -r -a 'hourly daily weekly monthly'
...
complete -c opa -n '__fish_seen_subcommand_from registry; and __fish_seen_subcommand_from list' -l status -d 'Filter by status' -r -a 'running success partial failed crashed dead unknown'
...
complete -c opa -n '__fish_seen_subcommand_from registry; and __fish_seen_subcommand_from complete update' -l status -d 'Completion status' -r -a 'success partial failed'
...
complete -c opa -n '__fish_seen_subcommand_from registry; and __fish_seen_subcommand_from complete update' -l rating-source -d 'Rating source' -r -a 'agent system user'
...
complete -c opa -n '__fish_seen_subcommand_from registry; and __fish_seen_subcommand_from analytics' -l view -d 'Analytics view' -r -a 'daily teams ratings'
...
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from show update attach comment move delete' -a '(__opa_ticket_ids)' -d 'Ticket ID'
...
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from create list' -l type -d 'Ticket type' -r -a 'feature bug task review-request work-report fyi idea question'
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from create list update' -l priority -d 'Priority' -r -a 'critical high medium low'
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from create update' -l estimate -d 'Estimate' -r -a 'XS S M L XL'
...
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from create list update' -l status -d 'Status' -r -a 'idea requirement-review pending-approval pending-implementation implementing review-uat done rejected cancelled'
...
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from update' -l blocked-by -d 'Blocking ticket IDs' -r -a '(__opa_ticket_ids)'
...
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from subticket create' -l parent -d 'Parent ticket ID' -r -a '(__opa_ticket_ids)'
...
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from subticket create' -l priority -d 'Priority' -r -a 'critical high medium low'
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from subticket create' -l estimate -d 'Estimate' -r -a 'XS S M L XL'
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from subticket create' -l type -d 'Subticket type' -r -a 'feature bug task review-request work-report fyi idea question'
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from subticket update' -a '(__opa_ticket_ids)' -d 'Subticket ID'
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from subticket complete' -a '(__opa_ticket_ids)' -d 'Subticket ID'
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from subticket list' -a '(__opa_ticket_ids)' -d 'Parent ticket ID'
...
complete -c opa -n '__fish_seen_subcommand_from trash; and __fish_seen_subcommand_from list' -l status -d 'Status' -r -a 'trashed restored purged'
complete -c opa -n '__fish_seen_subcommand_from trash; and __fish_seen_subcommand_from list move' -l type -d 'File type' -r -a 'code doc config data other'
