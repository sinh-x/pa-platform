...
function __opa_deploy_provider_name
    __opa_deploy_is_context; or return 1
...
function __opa_models_for_provider
    set -l provider (__opa_deploy_provider_name)
...
complete -c opa -n __fish_use_subcommand -a repository -d 'Inspect or safely quarantine repository ownership evidence'
...
complete -c opa -n '__fish_seen_subcommand_from repository; and not __fish_seen_subcommand_from inspect quarantine' -a 'inspect quarantine' -d 'Repository ownership action'
complete -c opa -f -n '__fish_seen_subcommand_from repository; and __fish_seen_subcommand_from inspect quarantine' -l repo -d 'Registered repository key or exact configured path' -r -a '(__opa_projects)'
complete -c opa -n '__fish_seen_subcommand_from repository; and __fish_seen_subcommand_from quarantine' -l expected-evidence -d 'Expected evidence identity from repository inspect' -r

complete -c opa -n __opa_deploy_needs_team -a '(__opa_deploy_team_candidates)' -d 'Team name'
complete -c opa -f -n __opa_deploy_should_offer_options -a '--mode --objective --objective-file --evaluate-deployment --list-modes --validate --provider --model --team-model --agent-model --background --dry-run --repo --ticket --timeout --resume --autonomy --force' -d 'Deploy option'
...
complete -c opa -n __opa_deploy_completing -l objective-file -d 'Objective from file' -r
complete -c opa -n __opa_deploy_completing -l list-modes -d 'List available deploy modes'
complete -c opa -n __opa_deploy_completing -l validate -d 'Validate team config'
...
complete -c opa -f -n __opa_deploy_completing -l team-model -d 'Deprecated model alias (PAP-147)' -r -a '(__opa_models_for_provider)'
complete -c opa -f -n __opa_deploy_completing -l agent-model -d 'Unsupported per-agent model override (PAP-148)' -r
...
complete -c opa -n __opa_deploy_completing -l force -d 'Recover stale or malformed builder ownership evidence'
complete -c opa -f -n __opa_deploy_completing -l repo -d 'Registered repository key or exact configured path' -r -a '(__opa_projects)'
...
complete -c opa -f -n __opa_deploy_completing -l autonomy -d 'Autonomy level' -r -a 'low medium high'
...
complete -c opa -f -n '__fish_seen_subcommand_from evaluate' -l repo -d 'Registered repository key or exact configured path' -r -a '(__opa_projects)'
...
complete -c opa -f -n '__fish_seen_subcommand_from evaluate' -l team-model -d 'Deprecated model alias (PAP-147)' -r
...
complete -c opa -n '__fish_seen_subcommand_from board' -l include-archived -d 'Include archived tickets'
...
complete -c opa -f -n '__fish_seen_subcommand_from registry; and __fish_seen_subcommand_from list' -l ticket -d 'Filter by projected current ticket' -r -a '(__opa_ticket_ids)'
...
complete -c opa -f -n '__fish_seen_subcommand_from registry; and __fish_seen_subcommand_from update' -l ticket -d 'Associate same-project ticket' -r -a '(__opa_ticket_ids)'
complete -c opa -f -n '__fish_seen_subcommand_from registry; and __fish_seen_subcommand_from update' -l expected-ticket -d 'Expected current ticket or none' -r -a 'none (__opa_ticket_ids)'
complete -c opa -n '__fish_seen_subcommand_from registry; and __fish_seen_subcommand_from update' -l actor -d 'Ticket association audit actor' -r
complete -c opa -n '__fish_seen_subcommand_from registry; and __fish_seen_subcommand_from update' -l reason -d 'Ticket association reason' -r
...
complete -c opa -n '__fish_seen_subcommand_from ticket; and not __fish_seen_subcommand_from create update list show attach comment move delete check-refs subticket archive unarchive' -a 'create update list show attach comment move delete check-refs subticket archive unarchive'
complete -c opa -f -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from show update attach comment move delete archive unarchive' -a '(__opa_ticket_ids)'
...
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from update' -l archive -d 'Archive ticket (terminal status only)'
...
complete -c opa -n '__fish_seen_subcommand_from ticket; and __fish_seen_subcommand_from subticket create' -l summary -d 'Subticket summary' -r
